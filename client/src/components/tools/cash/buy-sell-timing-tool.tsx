...
// Convert MasterDataService player to local format
const convertToLocalPlayer = (player: any) => {
  return {
    ...
    projectedIncrease: 0, // Will be calculated
    roleSecurity: 85, // Default value
    recommendedBuyRound: 21,
    recommendedSellRound: 25,
    breakeven: player.break_even || 80,
