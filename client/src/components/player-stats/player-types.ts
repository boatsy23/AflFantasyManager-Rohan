...
export interface BasePlayer {
  ...
  // Season totals (for Season Total view)
  totalKicks?: number | null;
  totalHandballs?: number | null;
  totalDisposals?: number | null;
  ...
  // Last game vs opponent/venue stats
...
export type OppositionSortField = 'name' | 'team' | 'nextOpponent' | 'averageVsOpp' | 'lastVsOpponent' | 'opponent3RoundDifficulty' | 'scoreImpact' | 'projectedAverage' | null;

export type VenueSortField = 'name' | 'team' | 'nextVenue' | 'averageAtVenue' | 'lastAtVenue' | 'averageAt3RoundVenue' | 'opponent3RoundDifficulty' | 'venueScoreVariance' | null;
