...
export default function PlayerDvpGraph() {
  ...
  // Determine player positions (handle dual positions) and convert to full names
  const playerPositions = useMemo(() => {
    ...
    // Convert position codes to full names for DVP API matching
    return positions.map(p => CODE_TO_FULL_NAME[p] || p);
  }, [selectedPlayer]);
