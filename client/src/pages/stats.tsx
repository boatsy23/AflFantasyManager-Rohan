...
import NewPlayerStats from "@/legacy/new-player-stats";
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function StatsPage() {
  ...
  // Fetch data from unified Master Stats API
      ...
      <div className="space-y-4">
        ...
        <div className="w-full">
          <div className="p-4 bg-gray-900 rounded-lg shadow-lg">
                ...
                <NewPlayerStats 
                  players={enhancedData.map((player: any) => ({
                    id: player.id || player.name,
                    name: player.name || 'Unknown',
                    team: player.team || 'Unknown',
                    position: player.position || 'Unknown',
                    price: player.price || 0,
                    averagePoints: player.averageScore || 0,
                    ...
                    pricePerPoint: player.price && player.averageScore ? (player.price / player.averageScore) : 0,
                    ...
                    totalKicks: player.totalKicks || 0,
                    totalHandballs: player.totalHandballs || 0,
                    totalDisposals: player.totalDisposals || 0,
                    totalMarks: player.totalMarks || 0,
