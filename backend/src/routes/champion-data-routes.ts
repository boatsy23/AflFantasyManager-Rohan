...
// import { championDataAPI } from '../champion-data-api'; // File removed

// Stub replacement since champion-data-api was removed
const championDataAPI = {
  isConfigured: () => false,
  testConnection: async () => ({ success: false, message: 'API removed' }),
  getLeagues: async () => null,
  getAFLLevels: async () => null,
