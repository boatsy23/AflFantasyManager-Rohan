...
import { registerRoutes } from "../../backend/src/utils/routes";
import { setupVite, serveStatic, log } from "../../backend/src/utils/vite";
...
(async () => {
  ...
  app.use('/guernseys', express.static(path.join(process.cwd(), 'public/guernseys')));
