...
export class MatchupDataProcessor {
  ...
  private filePath = path.join(process.cwd(), 'attached_assets', 'DFS_DVP_Matchup_Tables_FIXED_1753016059835.xlsx');
  ...
  async getTeamAbbreviation(fullTeamName: string): string {
