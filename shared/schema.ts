...
export const teamDvpRatings = pgTable("team_dvp_ratings", {
  ...
  // Forward DVP
  forwardRating: integer("forward_rating").notNull(),
  forwardAvgPointsAllowed: real("forward_avg_points_allowed").notNull(),
  forwardRank: integer("forward_rank").notNull(),
  
  // Midfielder DVP
  midfielderRating: integer("midfielder_rating").notNull(),
  midfielderAvgPointsAllowed: real("midfielder_avg_points_allowed").notNull(),
  midfielderRank: integer("midfielder_rank").notNull(),
  
  // Defender DVP
  defenderRating: integer("defender_rating").notNull(),
  defenderAvgPointsAllowed: real("defender_avg_points_allowed").notNull(),
  defenderRank: integer("defender_rank").notNull(),
  
  // Ruck DVP
  ruckRating: integer("ruck_rating").notNull(),
  ruckAvgPointsAllowed: real("ruck_avg_points_allowed").notNull(),
  ruckRank: integer("ruck_rank").notNull(),
});
